    	...
    	if (!file.isEmpty()) {
            try {
              //fileName = file.getOriginalFilename();
               ...
               String path="D:/";
                File dir=new File(path+ File.separator + "Downloads");
                if(!dir.exists())
                	dir.mkdirs();
               File fileNames=new File( File.separator  +".jpg");
                BufferedOutputStream buffStream = 
                        new BufferedOutputStream(new FileOutputStream(new File("D:/" +fileNames)));
